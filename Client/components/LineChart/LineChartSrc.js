    ...
    config.data.map((dataset,index)=>{
      ...
      output.push (
          <Path
            ...
            d={result}
            fill="none"
            stroke={this.props.chartConfig.lineColors[index]}
            strokeWidth={3}
          />
        )
      });
      ...
      <View style={style}>
        ...
        {this.props.labels &&
          <View style = {styles.labels}>
            <Text style = {styles.label1} > {this.props.labels[0]} </Text>
            <Text style = {styles.label2} > {this.props.labels[1]} </Text>
          </View>
        }
      </View>
    )
